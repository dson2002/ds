...
bot.on('message', message => {
    ...
    if (msg.startsWith(prefix + 'HELP')) { // We're also going to use a seperate JSON file, so we need to call it.
        ...
        if (msg === `${prefix}HELP`) { // If they only type this, lets ONLY show the commands for regular users
            ...
            embed.addField(`Divertissement`, "` \n x-8ball \n x-roll`", true)
            embed.addField("Utilitaire", "` x-avatar \n x-profil \n x-serverinfo \n x-botinfo \n x-id \n x-ping \n x-invite`", true)
            embed.addField(`Modération`, "` x-ban \n x-kick \n x-clear`", true)
            embed.addField(`Administration`, "` x-sondage \n x-say`", true)
            embed.addField(`Music commands`, "` \n play \n skip`\n stop \n volume  \n pause \n resume", true)
            embed.addField(`New commands`, "` \n .addrole \n .ban`\n .botinfo \n .clear  \n .coins \n .kick \n .level \n .pay \n .serverinfo \n .cat \n .tempmute \n .warn \n .warnlevel \n !debug \n %weather\n .Donare\.nunmute\n.Ticket\n.fortnite\n.botinvite\n.google",true)
            embed.addField(`New commands 2`, "` \n ~PING \n ~FUCK`\n ~USERSTATS",true)
            embed.addField(`Kali Linux`, "` \n kali-linux \n פוקודת-פריצה-למחשב`\n פוקודת-פריצה-לטלפון",true)
            embed.addField(`בוקורב`)
            embed.setFooter("discord.js#0560")
            ...
            message.channel.send({embed: {
                color: 0x1D82B6,
                description: `**שולח לך בפרטי ${message.author}!**`
            }})
